...
class SlConstants:
    ...
    POORLY_DIFFERENTIATED_THYROID_GLAND_CARCINOMA = "Poorly Differentiated Thyroid Gland Carcinoma"
    POORLY_DIFFERENTIATED_THYROID_GLAND_CARCINOMA_NCIT = 'NCIT:C6040'
